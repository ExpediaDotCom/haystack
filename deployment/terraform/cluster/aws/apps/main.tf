...
module "haystack-apps" {
  ...
  pipes_firehose_writer_firehose_streamname = "${data.terraform_remote_state.haystack_infrastructure.pipes_firehose_writer_firehose_stream_name}"
  ...
  haystack-console = "${var.haystack-console}"
