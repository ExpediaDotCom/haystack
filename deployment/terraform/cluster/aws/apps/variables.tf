...
variable "alerting" {
  ...
  default = {
    enabled = false
    version = "b5999890e29939f068ea0e2106cfaa4d4f605e6c"
  }
}
...
variable "ad-mapper" {
  ...
  default = {
    enabled = false
    instances = 1
    image = "expediadotcom/adaptive-alerting-ad-mapper:b5999890e29939f068ea0e2106cfaa4d4f605e6c"
...
variable "ad-manager" {
  ...
  default = {
    enabled = false
    instances = 1
    image = "expediadotcom/adaptive-alerting-ad-manager:b5999890e29939f068ea0e2106cfaa4d4f605e6c"
    image_pull_policy = "IfNotPresent"
    cpu_request = "500m"
    cpu_limit = "2000m"
    memory_request = "1024"
...
variable "aquila-detector" {
  ...
  default = {
    enabled = false
    instances = 1
    image = "expediadotcom/aquila-detector:b5999890e29939f068ea0e2106cfaa4d4f605e6c"
    image_pull_policy = "IfNotPresent"
    cpu_request = "500m"
    cpu_limit = "2000m"
    memory_request = "1024"
...
variable "aquila-trainer" {
  ...
  default = {
    enabled = false
    instances = 1
    image = "expediadotcom/aquila-trainer:b5999890e29939f068ea0e2106cfaa4d4f605e6c"
    image_pull_policy = "IfNotPresent"
    cpu_request = "500m"
    cpu_limit = "2000m"
    memory_request = "1024"
...
variable "alert-manager" {
  ...
  default = {
    enabled = false
    instances = 1
    image = "expediadotcom/alert-manager:d70cfadc99f81ad3e8992f901f97c392a5737c62"
    image_pull_policy = "IfNotPresent"
    cpu_request = "100m"
    cpu_limit = "1000m"
    memory_request = "500"
