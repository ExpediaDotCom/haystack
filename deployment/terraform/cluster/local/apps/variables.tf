...
variable "alerting" {
  type = "map"
  default = {
    version = "aeb25b8e87364380a465040c08373309038eeec8f6a6fde26a01dfa8dff8d081"
  }
}
...
variable "aquila-trainer" {
  ...
  default = {
    ...
    aquila_trainer_cpu_request = "100m"
    aquila_trainer_cpu_limit = "1000m"
    aquila_trainer_memory_request = "250"
    aquila_trainer_memory_limit = "250"
    aquila_trainer_jvm_memory_limit = "200"
