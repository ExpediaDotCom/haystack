...
module "pipes-firehose-writer" {
  ...
  firehose_fromtopic = "${var.pipes["firehose_writer_firehose_fromtopic"]}"
...
module "pipes-secret-detector" {
  cpu_limit = "${var.default_cpu_limit}"
  enabled = "${var.pipes["pipes_secret_detector_enabled"]}"
  env_vars = "${var.pipes["pipes_secret_detector_environment_overrides"]}"
  graphite_hostname = "${var.graphite_hostname}"
  graphite_port = "${var.graphite_port}"
  ...
  pipes_secret_detector_secretsnotifications_email_from = "${var.pipes["pipes_secret_detector_secretsnotifications_email_from"]}"
  pipes_secret_detector_secretsnotifications_email_host = "${var.pipes["pipes_secret_detector_secretsnotifications_email_host"]}"
  pipes_secret_detector_secretsnotifications_email_subject = "${var.pipes["pipes_secret_detector_secretsnotifications_email_subject"]}"
  pipes_secret_detector_secretsnotifications_email_tos = "${var.pipes["pipes_secret_detector_secretsnotifications_email_tos"]}"
  pipes_secret_detector_secretsnotifications_whitelist_bucket = "${var.pipes["pipes_secret_detector_secretsnotifications_whitelist_bucket"]}"
  replicas = "${var.pipes["pipes_secret_detector_instances"]}"
