...
module "ad-mapper" {
  ...
  replicas = "${var.ad-mapper["anomaly_detector_mapper_instances"]}"
  namespace = "${var.app_namespace}"
  kafka_endpoint = "${var.kafka_hostname}:${var.kafka_port}"
  graphite_hostname = "${var.graphite_hostname}"
  node_selecter_label = "${var.node_selector_label}"
  ...
  kubectl_executable_name = "${var.kubectl_executable_name}"
  kubectl_context_name = "${var.kubectl_context_name}"
  cpu_limit = "${var.ad-mapper["anomaly_detector_mapper_cpu_limit"]}"
  cpu_request = "${var.ad-mapper["anomaly_detector_mapper_cpu_request"]}"
  memory_limit = "${var.ad-mapper["anomaly_detector_mapper_memory_limit"]}"
  memory_request = "${var.ad-mapper["anomaly_detector_mapper_memory_request"]}"
  jvm_memory_limit = "${var.ad-mapper["anomaly_detector_mapper_jvm_memory_limit"]}"
  env_vars = "${var.ad-mapper["anomaly_detector_mapper_environment_overrides"]}"
}
...
module "ad-manager" {
  ...
  replicas = "${var.ad-manager["anomaly_detector_manager_instances"]}"
  namespace = "${var.app_namespace}"
  kafka_endpoint = "${var.kafka_hostname}:${var.kafka_port}"
  graphite_hostname = "${var.graphite_hostname}"
  node_selecter_label = "${var.node_selector_label}"
  ...
  kubectl_executable_name = "${var.kubectl_executable_name}"
  kubectl_context_name = "${var.kubectl_context_name}"
  cpu_limit = "${var.ad-manager["anomaly_detector_manager_cpu_limit"]}"
  cpu_request = "${var.ad-manager["anomaly_detector_manager_cpu_request"]}"
  memory_limit = "${var.ad-manager["anomaly_detector_manager_memory_limit"]}"
  memory_request = "${var.ad-manager["anomaly_detector_manager_memory_request"]}"
  jvm_memory_limit = "${var.ad-manager["anomaly_detector_manager_jvm_memory_limit"]}"
  env_vars = "${var.ad-manager["anomaly_detector_manager_environment_overrides"]}"
}
